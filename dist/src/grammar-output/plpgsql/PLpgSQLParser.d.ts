...
export declare class PLpgSQLParser extends Parser {
    ...
    static readonly RULE_query_schema_name = 309;
    static readonly RULE_set_qualifier = 310;
    static readonly RULE_table_subquery = 311;
    static readonly RULE_select_stmt = 312;
    static readonly RULE_after_ops = 313;
    static readonly RULE_select_stmt_no_parens = 314;
    static readonly RULE_with_clause = 315;
    static readonly RULE_with_query = 316;
    static readonly RULE_select_ops = 317;
    static readonly RULE_select_ops_no_parens = 318;
    static readonly RULE_select_primary = 319;
    static readonly RULE_select_list = 320;
    static readonly RULE_select_sublist = 321;
    static readonly RULE_into_table = 322;
    static readonly RULE_from_item = 323;
    static readonly RULE_from_primary = 324;
    static readonly RULE_alias_clause = 325;
    static readonly RULE_from_function_column_def = 326;
    static readonly RULE_groupby_clause = 327;
    static readonly RULE_grouping_element_list = 328;
    static readonly RULE_grouping_element = 329;
    static readonly RULE_values_stmt = 330;
    static readonly RULE_values_values = 331;
    static readonly RULE_orderby_clause = 332;
    static readonly RULE_sort_specifier_list = 333;
    static readonly RULE_sort_specifier = 334;
    static readonly RULE_order_specification = 335;
    static readonly RULE_null_ordering = 336;
    static readonly RULE_insert_stmt_for_psql = 337;
    static readonly RULE_insert_columns = 338;
    static readonly RULE_indirection_identifier = 339;
    static readonly RULE_conflict_object = 340;
    static readonly RULE_conflict_action = 341;
    static readonly RULE_delete_stmt_for_psql = 342;
    static readonly RULE_update_stmt_for_psql = 343;
    static readonly RULE_update_set = 344;
    static readonly RULE_notify_stmt = 345;
    static readonly RULE_truncate_stmt = 346;
    static readonly RULE_identifier_list = 347;
    static readonly RULE_anonymous_block = 348;
    static readonly RULE_comp_options = 349;
    static readonly RULE_function_block = 350;
    static readonly RULE_start_label = 351;
    static readonly RULE_declarations = 352;
    static readonly RULE_declaration = 353;
    static readonly RULE_type_declaration = 354;
    static readonly RULE_arguments_list = 355;
    static readonly RULE_data_type_dec = 356;
    static readonly RULE_exception_statement = 357;
    static readonly RULE_function_statements = 358;
    static readonly RULE_function_statement = 359;
    static readonly RULE_base_statement = 360;
    static readonly RULE_var = 361;
    static readonly RULE_diagnostic_option = 362;
    static readonly RULE_perform_stmt = 363;
    static readonly RULE_assign_stmt = 364;
    static readonly RULE_execute_stmt = 365;
    static readonly RULE_control_statement = 366;
    static readonly RULE_cursor_statement = 367;
    static readonly RULE_option = 368;
    static readonly RULE_transaction_statement = 369;
    static readonly RULE_message_statement = 370;
    static readonly RULE_log_level = 371;
    static readonly RULE_raise_using = 372;
    static readonly RULE_raise_param = 373;
    static readonly RULE_return_stmt = 374;
    static readonly RULE_loop_statement = 375;
    static readonly RULE_loop_start = 376;
    static readonly RULE_using_vex = 377;
    static readonly RULE_if_statement = 378;
    static readonly RULE_case_statement = 379;
    static readonly RULE_plpgsql_query = 380;
    ...
    query_schema_name(): Query_schema_nameContext;
...
export declare class Query_schema_nameContext extends ParserRuleContext {
    identifier(): IdentifierContext;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
    enterRule(listener: PLpgSQLParserListener): void;
